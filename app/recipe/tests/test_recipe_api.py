...
def sample_ingredient(user, name='Ingredient Test'):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Test Tag 1')
        recipe2 = sample_recipe(user=self.user, title='Test Tag 2')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Test Ing 1')
        ingredient2 = sample_ingredient(user=self.user, name='Test Ing 2')
